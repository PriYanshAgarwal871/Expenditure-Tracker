...
//            placeholder = { Text(text = "0")},
            leadingIcon = {
                Icon(painter = painterResource(id = rupeeID), contentDescription = "Rupee symbol")
            }
        )
...
//            placeholder = { Text(text = "0")},
        ...
        val updatedExpenditure = Expenditure(month.value, foodExpenditure.value.toInt() , utilityExpenditure.value.toInt() ,billExpenditure.value.toInt() , otherExpenditure.value.toInt() )
        val context = LocalContext.current
        Button(
            onClick = {
                expenditureViewModel.updateData(updatedExpenditure)
